  ...
  <header>
    ...
    <nav className={this.state.clicked ? 'nav1' : 'nav'}>
      <ul className="d-flex list-unstyled m-0">
        ...
        <li onClick={handleClick}><button className={this.props.isClicked ? 'lightmodeButton' : 'darkmodeButton'}><NavLink to="/Input">Use Hakiki</NavLink></button></li>
      </ul>
    </nav>
    <div className="desktop-nav">
      <nav className="topnav">
        <ul className="d-flex list-unstyled my-3">
          <li className="m-0">
            <NavLink exact to="/"></NavLink>
            <ul className="my-auto ml-2 list-unstyled"><li className="my-auto"><NavLink style={this.props.isClicked ? this.props.lightLinkColor : this.props.darkLinkColor} exact to="/">Hakiki</NavLink></li></ul>
          </li>
          ...
          <li className="my-auto"><button className={this.props.isClicked ? 'lightmodeButton' : 'darkmodeButton'}><NavLink to="/Input">Use Hakiki</NavLink></button></li>
