...
const Header = ({ isClicked }) => (
  <section className="row">
    <div className="col hero-text">
      <h1 className="wow fadeInDown" data-wow-duration="0.5s" data-wow-delay="0.1s">Hakiki</h1>
      ...
      <button className={isClicked ? 'lightmodeButton my-2 ' : 'darkmodeButton my-2'}><Link to="/Input">Use Hakiki</Link></button>
    </div>
    <div className="col hero-text">
